    ...
    def store_data_entities(self, data_entities: List[DataEntity]):
        ...
        with contextlib.closing(self._create_connection()) as connection:
            ...
            with self.clearing_space_lock:
                ...
                # print(f"before: size = {current_content_size}")
            ...
            # after_content_size = result2[0] if result2[0] else 0
            # print(f"after: size = {after_content_size}")
